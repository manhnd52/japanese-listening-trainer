        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/3 space-y-6">
            ...
            <div className="bg-white rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-8 flex flex-col items-center text-center">
              <div className="w-24 h-24 rounded-full bg-[#E8F5E9] flex items-center justify-center text-green-700 mb-4 overflow-hidden">
                {user.avatarUrl ? (
            ...
            {/* 2. Menu Navigation */}
            <div className="bg-white rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 bg-[#F0FDF4] border border-[#DCFCE7] rounded-xl text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={user.email}
                      readOnly
                      className="w-full pl-12 pr-4 py-3 bg-[#F0FDF4] border border-[#DCFCE7] rounded-xl text-gray-500 cursor-not-allowed"
                    />
                  </div>
                </div>
                ...
                <div className="flex justify-end pt-4">
                  <button
                    type="submit"
                    disabled={isLoading}
                    className={`flex items-center px-8 py-3 rounded-xl text-white font-bold shadow-md transition-all
                      ${isLoading 
