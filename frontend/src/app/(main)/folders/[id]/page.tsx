...
const FolderDetailPage = () => {
  ...
  useEffect(() => {
    ...
    // Cleanup: Clear currentFolder khi unmount để tránh show data cũ
    return () => {
  ...
  useEffect(() => {
    // Timeout warning nếu load quá lâu
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-600">
                    ...
                    {folder._count?.folderShares && folder._count.folderShares > 0 && (
                      <div className="flex items-center gap-1">
                        <Users size={16} />
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200">
          ...
          {!folder.audios || folder.audios.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600">Upload audio files to this folder to get started</p>
            </div>
          ) : (
            <div className="divide-y divide-gray-200">
              {folder.audios.map((audio, index) => (
                <div
                  key={audio.id}
                ...
                >
                  <div className="flex items-center gap-4">
                    {/* Play Button */}
                    <button className="w-10 h-10 flex-shrink-0 bg-brand-500 hover:bg-brand-600 rounded-full flex items-center justify-center text-white transition-colors shadow-md group-hover:shadow-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-600 truncate mt-1">
                        {audio.script.substring(0, 100)}{audio.script.length > 100 ? '...' : ''}
                      </p>
                    </div>
